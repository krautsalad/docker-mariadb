...
innodb_buffer_pool_size=$((memory_bytes * 65 / 100))
innodb_io_capacity=$((memory_gb * 80))
innodb_io_capacity_max=$((innodb_io_capacity * 2))
innodb_log_file_size=$((innodb_buffer_pool_size * 25 / 100))
key_buffer_size=$((memory_bytes * 10 / 100))
max_heap_table_size=$((memory_bytes * 4 / 100))
tmp_table_size=$((memory_bytes * 4 / 100))
